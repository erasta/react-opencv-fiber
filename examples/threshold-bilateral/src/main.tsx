...
const pipeline = `<CvCanvas>
  <cvThreshold thresh={thresh} maxval={255} type={0}>
    <cvCvtColor code={11}>
      <cvBilateralFilter d={d} sigmaColor={sigmaColor} sigmaSpace={sigmaSpace}>
        <cvCvtColor code={3}>
